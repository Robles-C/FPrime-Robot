// ======================================================================
// \title  Tank1Topology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef TANK1_TANK1TOPOLOGY_HPP
#define TANK1_TANK1TOPOLOGY_HPP
// Included for access to Tank1::TopologyState and Tank1::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <Tank1/Top/Tank1TopologyDefs.hpp>

// Remove unnecessary Tank1:: qualifications
 ...
 * Tank1::TopologyState see: Tank1TopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type Tank1::TopologyState see: Tank1TopologyDefs.hpp.
 *
